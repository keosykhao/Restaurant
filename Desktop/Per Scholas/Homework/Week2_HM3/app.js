...
// const array = [-1, 0, 1, 9, 9.5, 9.99, 10, 11, 20, 100];
...
// const word = ['alphabet', 'banana', 'carrot', 'doe', 'egg'];
// const wordsWithAtLeastFiveLetters = word.filter(word => word.length > 5)
